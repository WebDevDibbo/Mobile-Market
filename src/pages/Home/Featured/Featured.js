...
const Featured = () => {
    return (
        <div className='mb-32 mx-auto'>
             <h2 className='text-4xl text-center font-semibold mb-14'>Featured Category</h2>
             <div className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3  gap-8'>
             <div className='mb-5 rounded-lg  border pb-10 mx-auto'>
             ...
             <div className='mb-5  rounded-lg  border mx-auto'>
             ...
             <div className='mb-5  rounded-lg mx-auto'>
